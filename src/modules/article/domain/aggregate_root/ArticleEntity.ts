...
import { ArticleDocument, ArticleSchema } from '../models/schemas/Article.schema';
import { ObjectId } from 'mongoose';
import { CreateArticleDto } from '../../dtos/CreateArticle.dto';
export class ArticleEntity extends BaseAggregateRoot<ArticleSchema, ArticleDocument> {
