...
import { ArticleEntity } from '@app/modules/article/domain/models/entities/ArticleEntity';
import { ArticleResponseDto } from '@app/modules/article/dtos/ArticleResponse.dto';
import {
  ArticleDocument,
  ArticleSchema,
